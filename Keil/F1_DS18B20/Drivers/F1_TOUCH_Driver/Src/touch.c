 ...
 *  \note   连续读取READ_TIMES次数据,对这些数据升序排列,
 *  \note   然后去掉最低和最高LOST_VAL个数,取平均值 
 *  \retval 读到的坐标
 */ 
...
/*!
 *  \brief  保存较准参数到AT24C02芯片上
 *  \note   以下可以设置起始地址，占用空间为14byte
 */ 
