...
{
	HAL_LTDC_SetAlpha(&hltdc, transparency, s_CurrentLayer); /* 立即刷新 */
}
...
{
	HAL_LTDC_SetWindowSize_NoReload(&hltdc, _usWidth, _usHeight, s_CurrentLayer); /* 不立即更新 */
	HAL_LTDC_SetWindowPosition(&hltdc, _usX, _usY, s_CurrentLayer);				  /* 立即更新 */
}
...
{
	HAL_LTDC_SetWindowSize_NoReload(&hltdc, g_LcdWidth, g_LcdHeight, s_CurrentLayer); /* 不立即更新 */
	HAL_LTDC_SetWindowPosition(&hltdc, 0, 0, s_CurrentLayer);						  /* 立即更新 */
}
